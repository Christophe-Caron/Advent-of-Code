...
# number in the left list with the smallest number in the right list, then the second-smallest left number with the second-smallest right number, and so on.

#Within each pair, figure out how far apart the two numbers are;
# you'll need to add up all of those distances. For example, if you pair
# up a 3 from the left list with a 7 from the right list, the distance
...
# second-smallest number in the right list is another 3.
